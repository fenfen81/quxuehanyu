...
const COMMON = {
  ...
  "然后": "then; afterwards", "接着": "then; next", "后来": "afterwards; later",
  "首先": "first; first of all", "最后": "finally; last", "其实": "actually; in fact",
  "不过": "but; however", "而且": "and; moreover", "虽然": "although", "于是": "thereupon; as a result",
  ...
  "发烧": "to have a fever", "感冒": "to catch a cold", "咳嗽": "to cough",
  "头疼": "headache", "头痛": "headache", "嗓子": "throat", "嗓子疼": "sore throat",
  "肚子": "belly; stomach", "肚子疼": "stomachache", "拉肚子": "to have diarrhea",
  "大便": "stool; bowel movement", "小便": "urine; to urinate",
