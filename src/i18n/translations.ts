...
export const translations = {
  ...
  words_example_en_toggle: { zh: '例句英文', en: 'Ex. English' },
  words_example_audio_toggle: { zh: '自动读例句', en: 'Auto ex.' },
  words_view_strokes: { zh: '查看笔顺', en: 'Stroke Order' },

  // ── 教材查词 & 每课生词表预览 ──
  tb_search_placeholder: { zh: '搜索教材生词：汉字 / 拼音 / 英文', en: 'Search textbook words: hanzi / pinyin / English' },
  tb_no_match: { zh: '没有找到相关生词', en: 'No matching words' },
  tb_lookup_found_in: { zh: '出现于', en: 'Appears in' },
  tb_books: { zh: '本教材', en: 'textbooks' },
  tb_lesson_times: { zh: '个课次', en: 'lessons' },
  tb_lookup_occurrences: { zh: '出现位置', en: 'Where it appears' },
  tb_go_lesson: { zh: '背这一课', en: 'Study lesson' },
  tb_study_word: { zh: '背这个词', en: 'Study this word' },
  tb_word_count: { zh: '共 {n} 个生词', en: '{n} words' },
  tb_start_lesson: { zh: '开始背这一课', en: 'Study this lesson' },
  tb_total_places: { zh: '共 {n} 处', en: '{n} places' },
  tb_lookup_elsewhere: { zh: '查看该词在所有教材中的出现位置', en: 'See every textbook this word appears in' },
  tb_preview_btn: { zh: '预览生词表', en: 'Preview list' },
  tb_book_vocab_btn: { zh: '全册生词表', en: 'Whole-book list' },
  tb_book_stats: { zh: '{lessons} 课 · {entries} 词条 · {unique} 个不同词形 · 其中 {repeat} 个在多处出现', en: '{lessons} lessons · {entries} entries · {unique} unique forms · {repeat} appear elsewhere' },
  tb_filter_all: { zh: '全部', en: 'All' },
  tb_filter_repeat: { zh: '仅重复词', en: 'Repeated only' },
  tb_copy_list: { zh: '复制词表', en: 'Copy list' },
  cancel: { zh: '取消', en: 'Cancel' },
  vocab_print_title: { zh: '打印生词表', en: 'Print vocabulary list' },
  vocab_print_action: { zh: '导出 / 打印', en: 'Export / Print' },
  vocab_print_btn: { zh: '打印生词表', en: 'Print list' },
